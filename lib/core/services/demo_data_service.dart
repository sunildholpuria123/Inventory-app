...
class DemoDataService {
    ...
    for (final item in data) {
      final id = await db
        ...
        SuppliersCompanion.insert(
          ...
          phone: item.$2,
          creditBalance: Value(
            _random.nextInt(50000).toDouble(),
          ),
          gstNumber: const Value(
            '22AAAAA0000A1Z5',
          ),
        ),
      );
    ...
    for (final name in names) {
      final id = await db
        ...
        CustomersCompanion.insert(
          name: name,
          phone:
          '99911${_random.nextInt(99999)}',
          creditBalance: Value(
            _random.nextInt(20000)
                .toDouble(),
          ),
        ),
      );
  ...
  Future<List<int>> _insertProducts(
